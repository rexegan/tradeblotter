...
export default function TradeBlotter() {
  ...
  const [bdRecords, setBdRecords] = useState(() => {
    let r = STORED?.bdRecords || SAMPLE_BD;
    if (!STORED?.demoSeedV1) {
      const base = r.reduce((m, x) => Math.max(m, x.id), 0);
      r = [...DEMO_TRADES.map((d, i) => ({ ...d, id: base + 1 + i })), ...r];
    }
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      try {
        localStorage.setItem(STORAGE_KEY, JSON.stringify({ bdRecords, insRecords, settings, demoSeedV1: true }));
        setSavedAt(new Date());
      } catch {}
    }, 400);
...
const DEMO_TRADES = [
  { date: "08/03/2026", amount: "$250,000", qualified: "Q", lastName: "Abernathy", firstName: "Carl & Dena", fundsComingFrom: "Empower", currentAccountType: "401(k)", currentAssetClass: "Mutual Funds", currentPolicyNumber: "EMP-441209", receivingFirm: "Fidelity", newAccountType: "IRA", newAssetClass: "Mutual Funds", fundingMethod: "Direct Rollover", docsReceived: "IGO", docsReceivedChecked: true, trackingNumber: "1Z999AA10123456784", tradeEnteredAt: DEMO_NOW - 33 * DAY_MS, completedAt: DEMO_NOW - 21 * DAY_MS, dateFunded: "08/15/2026", newPolicyNumber: "FID-88231", commissionPaidDate: "08/22/2026", crmUpdated: "08/22/2026", notes: "American Funds Growth Portfolio — 401(k) rollover" },
  { date: "07/14/2026", amount: "$1,200,000", qualified: "NQ", lastName: "Baxter", firstName: "Gregory & Ann", fundsComingFrom: "Schwab", currentAccountType: "Joint", currentAssetClass: "Stocks", currentPolicyNumber: "SCH-70441", ticker: "NVDA", receivingFirm: "Fidelity", newAccountType: "Joint", newAssetClass: "Stocks", fundingMethod: "In-Kind Transfer (ACAT)", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 52 * DAY_MS, completedAt: DEMO_NOW - 46 * DAY_MS, dateFunded: "07/21/2026", newPolicyNumber: "FID-90112", commissionPaidDate: "07/29/2026", crmUpdated: "07/29/2026", notes: "NVIDIA + blue-chip basket — full ACAT in kind" },
  { date: "08/21/2026", amount: "$410,000", qualified: "Q", lastName: "Calloway", firstName: "Denise", fundsComingFrom: "TIAA", currentAccountType: "403(b)", currentAssetClass: "Mutual Funds", currentPolicyNumber: "TIAA-33871", receivingFirm: "Other", newAccountType: "IRA", newAssetClass: "Annuities", fundingMethod: "Direct Rollover", docsReceived: "In Process", trackingNumber: "1Z999AA10198765432", tradeEnteredAt: DEMO_NOW - 15 * DAY_MS, notes: "Athene Performance Elite 7 — FIA, 10% premium bonus" },
  { date: "09/01/2026", amount: "$85,000", qualified: "NQ", lastName: "Delgado", firstName: "Marco & Sofia", fundsComingFrom: "Vanguard", currentAccountType: "Joint", currentAssetClass: "ETFs", currentPolicyNumber: "VG-55210", receivingFirm: "American Funds", newAccountType: "529", newAssetClass: "Mutual Funds", fundingMethod: "Check", checkNumber: "4471", docsReceived: "NIGO", tradeEnteredAt: DEMO_NOW - 4 * DAY_MS, notes: "CollegeAmerica 529 — two kids, missing beneficiary page" },
  { date: "06/09/2026", amount: "$96,500", qualified: "Q", lastName: "Eastman", firstName: "Paul", fundsComingFrom: "TD Ameritrade", currentAccountType: "IRA", currentAssetClass: "ETFs", currentPolicyNumber: "TDA-20981", ticker: "VOO", receivingFirm: "Schwab", newAccountType: "Roth IRA", newAssetClass: "ETFs", fundingMethod: "Trustee-to-Trustee Transfer", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 90 * DAY_MS, completedAt: DEMO_NOW - 82 * DAY_MS, dateFunded: "06/17/2026", newPolicyNumber: "SCH-61022", commissionPaidDate: "06/30/2026", crmUpdated: "07/01/2026", notes: "Roth conversion — S&P 500 ETF position" },
  { date: "05/12/2026", amount: "$530,000", qualified: "NQ", lastName: "Fairbanks", firstName: "Eleanor", fundsComingFrom: "Morgan Stanley", currentAccountType: "Trust", currentAssetClass: "Bonds", currentPolicyNumber: "MS-77120", receivingFirm: "Fidelity", newAccountType: "Trust", newAssetClass: "Bonds", fundingMethod: "In-Kind Transfer (ACAT)", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 118 * DAY_MS, completedAt: DEMO_NOW - 109 * DAY_MS, dateFunded: "05/21/2026", newPolicyNumber: "FID-73301", commissionPaidDate: "05/30/2026", crmUpdated: "05/30/2026", notes: "Municipal bond ladder — family trust" },
  { date: "08/27/2026", amount: "$140,000", qualified: "Q", lastName: "Gustafson", firstName: "Erik & Maren", fundsComingFrom: "Bank", currentAccountType: "SEP IRA", currentAssetClass: "Money Market", currentPolicyNumber: "BK-10229", receivingFirm: "Bank", newAccountType: "SEP IRA", newAssetClass: "CDs", fundingMethod: "Trustee-to-Trustee Transfer", docsReceived: "Needs Attention", trackingNumber: "612345678912", tradeEnteredAt: DEMO_NOW - 9 * DAY_MS, notes: "12-month CD ladder — signature page missing" },
  { date: "04/06/2026", amount: "$300,000", qualified: "NQ", lastName: "Hollis", firstName: "Raymond & Judith", fundsComingFrom: "Prudential", currentAccountType: "Annuity", currentAssetClass: "Annuities", currentPolicyNumber: "PRU-99012", receivingFirm: "Other", newAccountType: "Annuity", newAssetClass: "Annuities", fundingMethod: "1035 Exchange", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 155 * DAY_MS, completedAt: DEMO_NOW - 139 * DAY_MS, dateFunded: "04/22/2026", newPolicyNumber: "JNL-44127", datePolicyDelivered: "05/01/2026", commissionPaidDate: "05/08/2026", crmUpdated: "05/08/2026", notes: "Jackson Perspective II VA — 1035 exchange, GMWB rider" },
  { date: "09/02/2026", amount: "$175,000", qualified: "Q", lastName: "Ibarra", firstName: "Luis", fundsComingFrom: "Principal", currentAccountType: "Pension", currentAssetClass: "Mutual Funds", currentPolicyNumber: "PRN-51733", receivingFirm: "Fidelity", newAccountType: "IRA", newAssetClass: "Alternatives", fundingMethod: "Direct Rollover", docsReceived: "In Process", tradeEnteredAt: DEMO_NOW - 2 * DAY_MS, notes: "Blackstone BREIT — alternatives sleeve, pension lump sum" },
  { date: "03/10/2026", amount: "$500,000", qualified: "NQ", lastName: "Jasper", firstName: "Beverly", fundsComingFrom: "John Hancock", currentAccountType: "Life Insurance", currentAssetClass: "Life Insurance", currentPolicyNumber: "JH-83920", receivingFirm: "Other", newAccountType: "Life Insurance", newAssetClass: "Life Insurance", fundingMethod: "1035 Exchange", docsReceived: "IGO", docsReceivedChecked: true, bankDraft: "Yes", draftStartDate: "04/01/2026", monthlyAmount: "$2,500", tradeEnteredAt: DEMO_NOW - 181 * DAY_MS, completedAt: DEMO_NOW - 164 * DAY_MS, dateFunded: "03/27/2026", newPolicyNumber: "PL-PDX-5501", datePolicyDelivered: "04/09/2026", commissionPaidDate: "04/17/2026", crmUpdated: "04/17/2026", notes: "Pacific Life PDX — 1035, $2,500/mo ongoing draft" },
  { date: "02/09/2026", amount: "$64,000", qualified: "Q", lastName: "Kowalski", firstName: "Stan & Ruth", fundsComingFrom: "Nationwide", currentAccountType: "SIMPLE IRA", currentAssetClass: "Mutual Funds", currentPolicyNumber: "NW-30412", receivingFirm: "American Funds", newAccountType: "IRA", newAssetClass: "Mutual Funds", fundingMethod: "60-Day Rollover", checkNumber: "1088", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 209 * DAY_MS, completedAt: DEMO_NOW - 198 * DAY_MS, dateFunded: "02/20/2026", newPolicyNumber: "AF-71203", commissionPaidDate: "02/27/2026", crmUpdated: "02/27/2026", notes: "SIMPLE-to-IRA after two-year rule — balanced portfolio" },
  { date: "09/03/2026", amount: "$220,000", qualified: "NQ", lastName: "Lindqvist", firstName: "Annika", fundsComingFrom: "Fidelity", currentAccountType: "Individual", currentAssetClass: "Stocks", currentPolicyNumber: "FID-11923", ticker: "AAPL", receivingFirm: "Fidelity", newAccountType: "Individual", newAssetClass: "Stocks", fundingMethod: "Journal", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 2 * 3600000, notes: "Apple concentrated position — journal to managed account" },
  { date: "08/11/2026", amount: "$38,500", qualified: "Q", lastName: "Montgomery", firstName: "Faith", fundsComingFrom: "Voya", currentAccountType: "HSA", currentAssetClass: "Money Market", currentPolicyNumber: "VY-60218", receivingFirm: "Fidelity", newAccountType: "HSA", newAssetClass: "Money Market", fundingMethod: "Trustee-to-Trustee Transfer", docsReceived: "In Process", tradeEnteredAt: DEMO_NOW - 25 * DAY_MS, notes: "HSA consolidation — invest above $2k cash floor" },
  { date: "01/13/2026", amount: "$52,000", qualified: "NQ", lastName: "Novak", firstName: "Peter & Il" + "ona", fundsComingFrom: "Vanguard", currentAccountType: "Custodial (UTMA)", currentAssetClass: "ETFs", currentPolicyNumber: "VG-88712", ticker: "VTI", receivingFirm: "Schwab", newAccountType: "Custodial (UTMA)", newAssetClass: "ETFs", fundingMethod: "In-Kind Transfer (ACAT)", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 236 * DAY_MS, completedAt: DEMO_NOW - 228 * DAY_MS, dateFunded: "01/21/2026", newPolicyNumber: "SCH-40917", commissionPaidDate: "01/30/2026", crmUpdated: "01/30/2026", notes: "UTMA for grandson — total market ETF" },
  { date: "08/30/2026", amount: "$275,000", qualified: "Q", lastName: "Okafor", firstName: "Chidi & Amara", fundsComingFrom: "Voya", currentAccountType: "457(b)", currentAssetClass: "Mutual Funds", currentPolicyNumber: "VY-71133", receivingFirm: "Other", newAccountType: "IRA", newAssetClass: "Annuities", fundingMethod: "Direct Rollover", docsReceived: "NIGO", trackingNumber: "9400111899223100004532", tradeEnteredAt: DEMO_NOW - 6 * DAY_MS, notes: "Allianz 222 FIA — resubmitting suitability form" },
  { date: "12/08/2025", amount: "$180,000", qualified: "NQ", lastName: "Pemberton", firstName: "Harold & June", fundsComingFrom: "Credit Union", currentAccountType: "Joint", currentAssetClass: "CDs", currentPolicyNumber: "CU-2201", receivingFirm: "Bank", newAccountType: "Joint", newAssetClass: "CDs", fundingMethod: "Wire", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 271 * DAY_MS, completedAt: DEMO_NOW - 262 * DAY_MS, dateFunded: "12/17/2025", newPolicyNumber: "BK-CD-9917", commissionPaidDate: "12/23/2025", crmUpdated: "12/23/2025", notes: "Maturing CDs rolled to higher-rate 18-month ladder" },
  { date: "11/03/2025", amount: "$71,500", qualified: "Q", lastName: "Quijano", firstName: "Rosa", fundsComingFrom: "T. Rowe Price", currentAccountType: "Roth IRA", currentAssetClass: "Mutual Funds", currentPolicyNumber: "TRP-91240", receivingFirm: "American Funds", newAccountType: "Roth IRA", newAssetClass: "Mutual Funds", fundingMethod: "Trustee-to-Trustee Transfer", docsReceived: "IGO", docsReceivedChecked: true, tradeEnteredAt: DEMO_NOW - 306 * DAY_MS, completedAt: DEMO_NOW - 297 * DAY_MS, dateFunded: "11/12/2025", newPolicyNumber: "AF-83112", commissionPaidDate: "11/21/2025", crmUpdated: "11/21/2025", notes: "Roth consolidation — growth & income funds" },
  { date: "08/18/2026", amount: "$650,000", qualified: "NQ", lastName: "Rasmussen", firstName: "Nils & Karen", fundsComingFrom: "Raymond James", currentAccountType: "Trust", currentAssetClass: "Real Estate", currentPolicyNumber: "RJ-55671", receivingFirm: "Other", newAccountType: "Trust", newAssetClass: "Real Estate", fundingMethod: "Other", docsReceived: "In Process", tradeEnteredAt: DEMO_NOW - 18 * DAY_MS, notes: "DST 1031 exchange — industrial real estate portfolio" },
  { date: "10/06/2025", amount: "$325,000", qualified: "Q", lastName: "Silverstein", firstName: "Marvin & Edith", fundsComingFrom: "MassMutual", currentAccountType: "IRA", currentAssetClass: "Annuities", currentPolicyNumber: "MM-47820", receivingFirm: "Nationwide", newAccountType: "Annuity", newAssetClass: "Annuities", fundingMethod: "Trustee-to-Trustee Transfer", docsReceived: "IGO", docsReceivedChecked: true, bankDraft: "Yes", draftStartDate: "11/01/2025", monthlyAmount: "$1,000", tradeEnteredAt: DEMO_NOW - 334 * DAY_MS, completedAt: DEMO_NOW - 320 * DAY_MS, dateFunded: "10/20/2025", newPolicyNumber: "NW-PEAK-3308", datePolicyDelivered: "10/29/2025", commissionPaidDate: "11/07/2025", crmUpdated: "11/07/2025", notes: "Nationwide Peak 10 FIA — income rider, $1,000/mo add" },
  { date: "09/04/2026", amount: "$95,000", qualified: "NQ", lastName: "Tran", firstName: "Vincent", fundsComingFrom: "Merrill Lynch", currentAccountType: "Individual", currentAssetClass: "Bonds", currentPolicyNumber: "ML-60912", receivingFirm: "Schwab", newAccountType: "Individual", newAssetClass: "Bonds", fundingMethod: "Wire", docsReceived: "Needs Attention", tradeEnteredAt: DEMO_NOW - 5 * 3600000, notes: "Treasury ladder 2y/3y/5y — wire instructions pending" },
];
